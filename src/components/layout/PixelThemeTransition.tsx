...
export function PixelThemeTransition({
  ...
  // Suppress unused variable warning (badgeVisible used for side-effect only)
  void badgeVisible;
    ...
    >
      ...
      {badgeVisible && (
        <div className="pointer-events-none absolute inset-0 grid place-items-center">
          <Icon
            icon={targetTheme === "dark" ? moonIcon : sunIcon}
            className="h-12 w-12 text-foreground opacity-60"
            aria-hidden="true"
          />
        </div>
      )}
